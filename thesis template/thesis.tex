...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\name{Samuel}{Skinner}
\title{The Unicycle as a Dynamical System}
...
\input{chapters/2 - modeling.tex}
\input{chapters/3 - simulation.tex}
\input{chapters/4 - linearization.tex}
\input{chapters/5 - estimation.tex}
\input{chapters/6 - control.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendices
\input{chapters/Appendix A - derivations.tex}
