...
$$\dot{\state} = \bmat{\dot{q} \\ \ddot{q}} = f(q, \dot{q}, u)$$.
...
$\ddot{q} = g(q, \dot{q}, u)$ which models the dynamics of the system as the
...
the Y axis an angle $\theta$. These orientations can be codified in the rotation 
...
height $h$ with gravitational acceleration $g$ as $E = mgh$.
...
$$\mathcal{Q} = B_{map}u = \bmat{0&-1/r \\ -1/r&0 \\ 0&1 \\ 1&0}
